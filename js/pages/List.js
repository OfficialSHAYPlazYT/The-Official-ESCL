        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <div class="og">
                        <p class="type-label-md">Website layout made by <a href="https://easydemonlist.7m.pl and https://tsl.pages.dev/#//" target="_blank">TheShittyList</a></p>
                    </div>
                    ...
                    <p>
                        Do not use easy modes, only a record of the unmodified level qualifies, custom ldm is allowed if uploaded to the servers
                    </p>
                    <p>
